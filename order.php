...
let id = <?php echo json_encode($this->session->userdata('userdata')
['id'] ?? null);  ?>
...
bookingDetails.innerHTML = `
  ...
  <div class="hotelBookCheckIN-out">
    ...
    <div class="checkIN">
      ...
      <h6>${formatDateParts(el.startDate).weekday} <span>${formatDateParts(el.startDate).day}
       ${formatDateParts(el.startDate).month}</span> ${formatDateParts(el.startDate).year}</h6>
      <p>12 PM</p>
    </div>
    ...
    <div class="checkIN">
      ...
      <h6>${formatDateParts(el.endDate).weekday} <span>${formatDateParts(el.endDate).day}
       ${formatDateParts(el.endDate).month}</span> ${formatDateParts(el.endDate).year}</h6>
      <p>12 PM</p>
    </div>

    <div class="checkIN checkIN2">
    <span><b>${el.nights}</b> Nights</span>
    <span>${el.peopleValue}</span> People
